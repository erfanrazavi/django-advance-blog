...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ['id' , 'author', 'title' ,'image', 'content' ,'category',  'absolute_url', 'snippet' ,  'status' ,'relative_url', 'created_date' , 'published_date']
    ...
    def to_representation(self, instance):
        ...
        rep['category'] = CategorySerializer(instance.category , context={'request' : request}).data #When we want to call the serializer elsewhere, we pass the request along with it
